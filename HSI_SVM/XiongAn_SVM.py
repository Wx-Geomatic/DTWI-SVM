...
@author: wx
"""
# 程序说明：此程序用于雄安高光谱数据的SVM水体提取的方法-2021.01.29
...
traindata = xlrd.open_workbook(r'F:\wx\XASVM\traindata.xlsx')
...
# 5、用训练好的模型去识别提取水体
# 5.1 读取识别影像数据
Datapath = "F:/wx/XASVM/Xiongan/Xiongan.hdr" 

# 	Data Source:   'F:/wx/XASVM/Xiongan/Xiongan.img'
# 	# Rows:           1580
# 	# Samples:        3750
# 	# Bands:           256
# 	Interleave:        BSQ
